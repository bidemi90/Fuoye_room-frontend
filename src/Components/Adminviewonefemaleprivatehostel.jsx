...
const Adminviewonefemaleprivatehostel = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      axios
        .post("https://fuoye-room-backend.onrender.com/user/updatePrivateFemaleHostelOccupant", {
          occupant: values.occupant,
          old_occupant: occupantcurrentid.occupant,
          privatefemalehostel_id: allprivatefemalehostel[id]._id,
          room_id: occupantcurrentid.room_id,
      ...
      {isFetchingAllprivatefemalehostel ? (
        ...
        <section>
          ...
          <div className=" d-flex justify-content-evenly oneprivatehouseholder flex-wrap ">
            ...
            <div className=" ms-3 col-12 col-lg-6  pt-3 ">
              ...
              <p className="onelinetext text-capitalize fw-semibold">
                ...
                {allprivatefemalehostel[id].is_furnished ? "✔️" : "❌"}
              </p>
          ...
          <div className=" d-flex justify-content-center align-items-center">
            <Link
              to={`/management_page/editonefemaleprivatehostel/${id}`}
          ...
          <div class="modal-content">
            <div class="modal-header modalbgcolorchange">
              <h5 class="modal-title   " id="staticBackdropLabel">
                building name :{allprivatefemalehostel[id].building_name}
              </h5>
