...
const Adminroompage = () => {
  return (
    <>
    <section>
        <p className=" fs-4 fw-bold text-uppercase ">room management</p>
        <div className=" onecategoryholder mt-4 p-4 rounded-4 ">
          ...
          <div className=" col-6">
          <Link to="/management_page/school_male_hostel" className=" categorytypediv col-11 m-auto p-2 border-0 rounded-3 d-flex flex-column justify-content-center align-items-center py-5">
          ...
          <div className=" col-6">
          <Link to="/management_page/school_female_hostel" className=" categorytypediv col-11 m-auto p-2 border-0 rounded-3 d-flex flex-column justify-content-center align-items-center py-5">
