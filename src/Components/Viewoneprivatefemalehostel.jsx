  ...
  return (
    <>
      ...
      {isFetchingAllprivatefemalehostel ? (
        ...
        url(${
          allprivatefemalehostel[id].img_array !== ""
            ? allprivatefemalehostel[id].img_array
            : imageUrl
        })
    `,
            ...
            <div className="flex p-4 testingnewcompodiv">
              <p className=" text-light fw-bold fs-4 m-0">
                <span className=" text-capitalize">
                  NAME: {allprivatefemalehostel[id].building_name}
                </span>
              </p>
            </div>
          </div>
            ...
            <div className=" p-2">
              ...
              <div className=" mb-2  p-1  ">
                <p className=" m-0  smalltextnote fst-italic fw-bold font">
                  <span className=" text-capitalize">Checkbox behavior </span>:
                  If a checkbox is checked, it means that the corresponding room
                  is occupied. If it's unchecked, the room is unoccupied.
                </p>
              </div>
            </div>
